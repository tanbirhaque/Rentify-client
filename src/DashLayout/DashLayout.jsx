  ...
  return (
    ...
    <Helmet>
      ...
      <div className="flex">
        ...
        <div
          className={`side_bar bg-[#0f172a] min-h-screen fixed w-64 xl:min-w-[300px] z-[99999] text-white transition-all duration-300 ${isSidebarOpen ? "-ml-64 xl:ml-0" : "xl:-ml-[300px]"
            }`}
        >
          <SideBar></SideBar>
        </div>
