                    ...
                    <div className="min-w-1/4 flex-grow pt-3">
                        ...
                        <div className="mt-[6px]">
                            ...
                            <div className="flex justify-center">
                                ...
                                <Link to={`/dashboard/payment?price=${property_details?.property_price}&requestId=${_id}&propertyId=${propertyID}&owner=${owner_email}&property_img=${property_img}&property_title=${property_title}`}
