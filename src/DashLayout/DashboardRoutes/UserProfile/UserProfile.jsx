                        ...
                        <div className=" border-t-2 mt-5 border-gray-100 dark:border-gray-700">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex items-center mt-3">
                                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="fea icon-ex-md text-slate-400 me-3 w-6 h-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Skills :</h6>
                                ...
                                <div className="flex items-center mt-3">
                                    ...
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Language :</h6>
                                ...
                                <div className="flex items-center mt-3">
                                    ...
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Website :</h6>
                                ...
                                <div className="flex items-center mt-3">
                                    ...
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Birthday :</h6>
                                        <p className="text-slate-400 mb-0">2nd March, 1996</p>
                                    </div>
                                </div>
                                <div className="flex items-center mt-3">
                                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="fea icon-ex-md text-slate-400 me-3 w-6 h-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle>
                                    </svg>
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Location :</h6>
                                ...
                                <div className="flex items-center mt-3">
                                    ...
                                    <div className="flex-1">
                                        <h6 className="text-[#002172] dark:text-white font-medium mb-0">Cell No :</h6>
