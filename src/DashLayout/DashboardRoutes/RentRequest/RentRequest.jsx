...
const RentRequest = () => {
  ...
  const accepted = ownerRent.filter((item) => item.requestStatus == "accepted");
  const pending = ownerRent.filter((item) => item.requestStatus == "pending");
  const rejected = ownerRent.filter((item) => item.requestStatus == "rejected");
    ...
    <>
      <section className="py-1 bg-[#f3f3f3] w-full min-h-screen">
        ...
        <div className=" flex gap-8 mx-auto py-5 w-[93%]">
          ...
          <div className="flex bg-white py-7 shadow-md  px-10 items-center justify-between gap-20 w-[880px] rounded-2xl">
            ...
            <div className="text-lg">
              ...
              <h1>
                Rent Request transforms real estate transactions by connecting
        ...
        <div className="mt-10 w-[93%] bg-white px-6 mx-auto mb-20 shadow-lg rounded-lg">
          <table className="table text-lg overflow-x-auto">
            {/* head */}
