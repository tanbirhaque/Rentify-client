...
const ButtonRed = ({ titleRed }) => {
  return (
    ...
    {/* removed mb-2 tailwind class from the button tag by -Tanbir for design purpose */}
      <button className="w-full h-full p-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-yellow-500 text-white relative overflow-hidden group z-10 hover:text-white duration-1000">
