...
const ButtonRed = ({ titleRed }) => {
  return (
    <>
      <button className="w-full h-full p-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2 bg-[#Ec3323] text-white relative overflow-hidden group z-10 hover:text-white duration-1000">
