...
const ButtonBlue = ({ titleBlue, padX='px-5', padY='py-2.5' }) => {
  return (
    <>
      ...
      <button className={`font-semibold ${padX} ${padY} rounded-lg text-sm text-center bg-[#002172] text-white relative overflow-hidden group z-10 hover:text-white duration-1000`}>
