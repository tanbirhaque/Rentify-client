      ...
      >
        ...
        >
          <div className="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            <div className="w-[300px] flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
              ...
              <p className="mt-2  text-sm font-medium text-white py-5 ">
             Discover seamless living with Rebtify – your premier destination for hassle-free online rentals. Browse a curated selection of top-quality homes, apartments,and more. 
              </p>
            ...
            <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
              ...
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10 pt-3 ">
                  <li className="items-center flex py-2 gap-3">
                    {" "}
                    <IoIosArrowForward className="text-xl text-[#e33226] font-bold" />
                    <a className="text-white hover:text-[#e33226] text-lg  font-medium cursor-pointer">
                      New York City
                    </a>
                  </li>
                  <li className="items-center flex py-2 gap-3">
              ...
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                <iframe
                  className="md:max-w-[350px] md:h-[310px] w-full h-full"
          ...
          <div className="bg-white-100 py-2">
            <div className="container mx-auto py-2 px-5 flex flex-wrap flex-col sm:flex-row">
              <p className="text-white text-base text-center sm:text-left font-semibold">
                © 2024 Rentify —
                <a
                  href="https://twitter.com/knyttneve"
                  rel="noopener noreferrer"
                  className="text-white ml-1 text-base"
                  target="_blank"
                >
                  All rights reserved at{" "}
                  <span className=" text-[#e33226] font-bold text-lg">
                    @rentify.com
                  </span>
                </a>
              </p>
              <span className="inline-flex sm:ml-auto sm:mt-0  justify-center sm:justify-start">
                <a className="hover:text-[#e33226]" href="https://www.facebook.com" target=" ">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                ...
                <a
                  className="ml-3 hover:text-[#e33226]"
