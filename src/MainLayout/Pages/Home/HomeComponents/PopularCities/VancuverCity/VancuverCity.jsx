...
const VancuverCity = () => {
    ...
    const cityProperties = properties.filter(property => property?.property_info.property_location.address.city === 'Vancouver City')
        ...
        <div className="img6">
                <div className=" bg-[#000000B2]">
                    <div className=" max-w-screen-2xl mx-auto py-24">
                        <h2 className="md:text-6xl text-2xl font-bold text-white font-serif">All Properties in Vancuver City</h2>
                        <div className="mt-2">
            ...
            <TabPanel>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-3 xl:px-0">
                ...
                {property.length > 0
                  ...
                  :  cityProperties?.map((property) => <PropertyCard key={property._id} property={property}></PropertyCard>)}
              </div>
            </TabPanel>
            <TabPanel>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-3 xl:px-0">
