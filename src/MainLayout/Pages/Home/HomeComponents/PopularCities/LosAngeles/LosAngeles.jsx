...
const LosAngeles = () => {
    ...
    const cityProperties = properties.filter(property => property?.property_info.property_location.address.city === 'Los Angeles')
    ...
    return (
        <>
          <Helmet>
        <title>Rentify | Los Angels</title>
        ...
        <div className="img8">
                <div className=" bg-[#000000B2]">
                    <div className=" max-w-screen-2xl mx-auto py-24">
                        <h2 className="md:text-6xl text-2xl font-bold text-white font-serif">All Properties in Los Angeles</h2>
                        <div className="mt-2">
