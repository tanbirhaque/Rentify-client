...
const Prauge = () => {
    ...
    const cityProperties = properties.filter(property => property?.property_info.property_location.address.city === 'Prauge')
        ...
        <div className="img2">
                <div className=" bg-[#000000B2]">
                    <div className=" max-w-screen-2xl mx-auto py-24">
                        <h2 className="text-6xl font-bold text-white font-serif">All Properties in Prauge</h2>
                        <div className="mt-2">
