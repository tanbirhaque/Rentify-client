      ...
      <div>
        ...
        <div className="p-16 bg-[#f9f9f9] flex-col md:flex-row text-center items-center justify-center space-y-7">
          <h1 className="text-2xl md:text-[40px] font-bold">
            Booking Your Home in 3 Simple Steps
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-20 ">
            ...
            <div className="flex flex-col items-center">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://i.ibb.co/9ydVR9B/hw-shape-1.png)",
                }}
              >
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[#666666]">
                Confirm your reservation effortlessly. Verify your details,
                secure your dream property, and get ready to move into your new
                home.
              </p>
            </div>
          </div>
