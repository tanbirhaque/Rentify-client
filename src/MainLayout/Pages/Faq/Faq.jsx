      ...
      <div>
        ...
        <div className="flex p-28 bg-[#f9f9f9] flex-col md:flex-row">
          ...
          <div className="flex-1">
            ...
            {/* accordion */}
            {/* <div className=" my-5 join join-vertical w-full h-full"> */}
            <div className="my-5 w-full">
                ...
                <details className="collapse">
                  ...
                  <div className="collapse-content">
                    <p>
                      ...
                      preferences. Our user-friendly interface makes it simple
                      to find the perfect home for your needs.
                    </p>
                  </div>
                </details>
              </div>
                ...
                <details className="collapse ">
                  ...
                  <div className="collapse-content">
                    <p>
                      ...
                      information such as the property&#39;s address, rental
                      price, number of bedrooms and bathrooms, amenities, and a
                      detailed description. You&#39;ll also find high-quality
                      photos to give you a comprehensive view of the property.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="mb-5 bg-white">
                <details className="collapse ">
                  ...
                  <div className="collapse-content">
                    <p>
                      The inclusion of utilities varies from property to
                      property. Some rentals may include certain utilities in
                      the monthly rent, while others may require tenants to pay
                      for utilities separately. Check the individual property
                      listings for detailed information on what is covered in
