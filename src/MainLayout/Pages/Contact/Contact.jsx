            ...
            <div className="mb-24 flex md:flex-row flex-col justify-center items-center gap-5">
              <div
                className=" md:w-full w-11/12 mx-auto h-[200px] shadow-2xl flex flex-col justify-center items-center relative
                         py-10"
              >
                <p className=" bg-red-600 hover:bg-purple-900 h-20 w-20 rounded-full flex flex-col justify-center items-center absolute -top-9">
                  <CiLocationOn className="text-5xl font-bold text-white"></CiLocationOn>
                </p>
                <h2 className=" text-2xl font-bold">Visit Us Anytime</h2>
                <p className=" text-gray-500 text-center">
                  342/A Brooklyn St, Milton Avenue,
                  <br />
                  New York, USA
                </p>
              </div>
              <div className="md:w-full w-11/12 mx-auto h-[200px] shadow-2xl flex flex-col justify-center items-center relative">
                <p className=" bg-red-600 hover:bg-purple-900 h-20 w-20 rounded-full flex flex-col justify-center items-center absolute -top-9">
                  <MdOutlineEmail className="text-5xl font-bold text-white"></MdOutlineEmail>
                </p>
                <h2 className=" text-2xl font-bold">Visit Us Anytime</h2>
                <p className=" text-gray-500 text-center">
                  342/A Brooklyn St, Milton Avenue,
              ...
              <div className=" md:w-full w-11/12 mx-auto h-[200px] shadow-2xl flex flex-col justify-center items-center relative">
                <p className=" bg-red-600 hover:bg-purple-900 h-20 w-20 rounded-full flex flex-col justify-center items-center absolute -top-9">
                  <LuPhoneCall className="text-5xl font-bold text-white"></LuPhoneCall>
                </p>
                <h2 className=" text-2xl font-bold">Visit Us Anytime</h2>
                <p className=" text-gray-500 text-center">
                  342/A Brooklyn St, Milton Avenue,
            ...
            <div className=" flex justify-around items-center gap-5">
              <div className=" w-1/2">
                ...
                <p className=" leading-10 text-gray-500 mb-7 text-left text-xl">
                  We aim to provide personalized assistance for all your real
                  estate needs. Whether you&#39;re looking for property
                  listings, seeking guidance on the buying or selling process,
                  or have general inquiries, our team is here to support you
                  every step of the way. With our expertise and dedication,
                  we&#39;re committed to helping you find your dream home.
                </p>
                <div className=" flex items-center gap-5 text-xl">
                  <a
                    target="blank"
                    href="https://www.facebook.com/roknujjamansajib"
                    className=" bg-gray-200  rounded-full text-[#002172] text-xl p-2"
                  >
                  ...
                  <a
                    ...
                    className="bg-gray-200 text-xl  rounded-full text-[#002172] p-2"
                  >
                    <FaTwitter></FaTwitter>
                  </a>
                  <a
              ...
              <div className=" w-1/2">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <textarea
                    ...
                    className="textarea textarea-bordered h-40 w-full mt-3 mb-4"
                  ...
                  <input
                    type="submit"
                    value="Send Message"
                    className=" rounded px-8 py-4 mt-3 bg-[#EC3323] hover:bg-[#002172] text-white"
                  />
                </form>
              </div>
            </div>
